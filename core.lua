...
local function UpdateFonts()
	...
	SetFont(_G.NumberFont_GameNormal, GMFONTS["N"], 13, "")           -- orig 10 -- inherited by WhiteNormalNumberFont, tekticles = 11
...
local options = CreateFrame("Frame", ADDON .. "Options")
...
local gmlistfonts = { "Ubuntu", "Ubuntu Mono", "Ubuntu Light", "Carlito", "PT Sans", "ComicNeue", "Candara", "Verdana",
	"Laurel", "Lato", "Noto", "Noto Sans", "Roboto", "OpenDyslexic" }
...
function dropdown2:OnValueChanged(text)
	...
	gmfontset["Carlito"]      = { "Carlito-Regular.ttf", "Carlito-Bold.ttf", "Carlito-BoldItalic.ttf",
		"Carlito-Italic.ttf" }
	gmfontset["PT Sans"]      = { "PT_Sans-Web-Regular.ttf", "PT_Sans-Web-Bold.ttf", "PT_Sans-Web-BoldItalic.ttf",
		"PT_Sans-Web-Italic.ttf" }
	gmfontset["ComicNeue"]    = { "ComicNeue-Regular.ttf", "ComicNeue-Bold.ttf", "ComicNeue-Bold.ttf",
	...
	gmfontset["Noto"]         = { "NotoSerif-Regular.ttf", "NotoSerif-Bold.ttf", "NotoSerif-Italic.ttf",
		"NotoSerif-BoldItalic.ttf" }
	gmfontset["Noto Sans"]    = { "NotoSans-Regular.ttf", "NotoSans-Bold.ttf", "NotoSans-Italic.ttf",
		"NotoSans-BoldItalic.ttf" }
	gmfontset["Roboto"]       = { "Roboto-Regular.ttf", "Roboto-Bold.ttf", "Roboto-Italic.ttf", "Roboto-BoldItalic.ttf" }
	gmfontset["OpenDyslexic"] = { "OpenDyslexic-Regular.otf", "OpenDyslexic-Bold.otf", "OpenDyslexic-Italic.otf",
...
slidertxt:SetText(string_format("|cffffffff%s|r : %s", "Size delta", "Modify the fonts size with this delta"))
...
slider.value:SetText(tostring(GMFONTS["delta"]))
slider:SetScript("OnValueChanged", function(self, value)
	GMFONTS["delta"] = floor(value + 0.5)
	self.value:SetText(tostring(GMFONTS["delta"]))
end)
...
local gmfonts_def_button = CreateFrame("Button", nil, options, "UIPanelButtonTemplate")
...
-- WoW Default Fonts Button
local gmfonts_rld_button = CreateFrame("Button", nil, options, "UIPanelButtonTemplate")
...
credits:SetText(
"Font engine: |cffffd200tekticles|r by tekkub      Widget engine: |cffffd200PhanxConfig-Dropdown|r by phanx")
